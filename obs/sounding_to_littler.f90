...
! read input date now
!
      print*,'Enter the mdate for conversion from radisonde to litte_r'
      read*,mdate
      print*,'Enter data is',mdate
!
...
17    fid          = idrs(i)
      ...
      READ(12,*)
      j            = 1
18    READ(12,*,end=19,err=19)p1(j),z1(j),t1(j),td1(j),tem1,tem1,di(j),sp(j)
