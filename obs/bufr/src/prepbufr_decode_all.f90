...
!
!
 open(24,file='prepbufr_table.txt')
 open(unit_in,file='test2_data.bufr',form='unformatted',status='old')
 ...
 call datelen(10)
   ...
   msg_report: do while (ireadmg(unit_in,subset,idate) == 0)
     ...
     sb_report: do while (ireadsb(unit_in) == 0)
       ...
       DO k=1,1
         write(*,'(i3,a5,9f14.1)') k,'obs=',(obs(i,k),i=1,9)
         write(*,'(i3,a5,9f14.1)') k,'oer=',(oer(i,k),i=1,7)
         write(*,'(i3,a5,9f14.1)') k,'qcf=',(qcf(i,k),i=1,7)
       ENDDO
       READ*
     enddo sb_report
   enddo msg_report
