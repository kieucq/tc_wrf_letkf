...
!        2. a decodeoutput file
! 
!#################################################################
 program prepbufr_decode_radiosonde
 implicit none
...
!
 open(20,file='prepbufr_decode_table_upperair.txt')
 open(21,file='prepbufr_decode_data_upperair.dat')
