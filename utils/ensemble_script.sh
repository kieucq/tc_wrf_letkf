...
#
prename="felix"                # prename for the case we're workin on
ninterval=3                    # output interval of wrfout
working_dom="d01"              # working domain
rm -f wrfout_*
#
...
echo "YDEF $ne  LINEAR 1 1" >> ensemble_tseries.ctl
