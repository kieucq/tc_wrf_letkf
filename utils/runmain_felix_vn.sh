...
#
DIR_MAN="/mnt/metglfs3/maiht/da_letkf_wrf"
DIR_RUN=`pwd`
...
DIR_GRIB_DATA="${DIR_MAN}/data/avn/20100713"
...
d01_year="2010"                                      # start year for domain 1
d01_month="07"				   	     # start month for domain 1
d01_day="19"                                         # start day for domain 1
d01_hour="12"                                        # start hour for domain 1
d01_minute="00"                                      # start minute for domain 1
d02_year=$d01_year                                   # start year for domain 2
d02_month="07"                                       # start month for domain 2
d02_day="13"                                         # start day for domain 2
d02_hour="00"                                        # start hour for domain 2
d02_minute="00"                                      # start minute for domain 2
d03_year=$d01_year                                   # start year for domain 3
d03_month="07"                                       # start month for domain 3
d03_day="13"                                         # start day for domain 3
...
ref_lat="13.8"                                       # reference lat for the domain center (mercator proj)
ref_lon="-72.9"                                      # reference lon for the domain center (mercator proj)
...
maximum_dom=1                                        # maximum number of WRF domain
...
mpirun -np 8 ./wrf.exe
rm -f *.TBL *.tbl tr*t* *DATA* ozone* *.exe grib* *.output wrf_err wrf_out README* co2_trans*
mpdallexit
EOF1
