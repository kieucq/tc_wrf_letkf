...
#
d01_nx=451                                           # number of grid point in x-dim for WRF namelist
d01_ny=451                                           # number of grid point in y-dim for WRF namelist
d01_nz=31                                            # number of grid point in z-dim for WRF namelist    
d01_dx=2500                                         # dx for domain 1 in m
d01_dy=2500                                         # dy for domain 1 in m
d01_dt=18                                           # dt for domain 1 in second
...
ref_lat="6.3"                                        # reference lat for the domain center (mercator proj)
ref_lon="1.0"                                        # reference lon for the domain center (mercator proj)
...
obsmode="REAN"                                       # BVOX, radioson(RADS), radar(RADA), reanaly(REAN), CIMSS
